...
var _testLinkConfig = require('../common/testLinkConfig');

var _testLinkConfig2 = _interopRequireDefault(_testLinkConfig);
...
exports.default = function () {
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      {
        initialEntries: _testLinkConfig2.default.map(function (link) {
          return link.path;
        }),
        initialIndex: 0
      },
      _react2.default.createElement(
        ...
        _react2.default.createElement(_ApplicationTabs2.default, { id: 'test-tabs', links: _testLinkConfig2.default })
      )
    )
  );
};