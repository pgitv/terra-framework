...
var _testExternalConfig = require('../common/testExternalConfig');

var _testExternalConfig2 = _interopRequireDefault(_testExternalConfig);
...
exports.default = function () {
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      {
        initialEntries: _testExternalConfig2.default.map(function (link) {
          return link.path;
        }),
        initialIndex: 0
      },
      _react2.default.createElement(
        ...
        _react2.default.createElement(_ApplicationTabs2.default, { id: 'test-tabs', alignment: 'end', links: _testExternalConfig2.default })
      )
    )
  );
};