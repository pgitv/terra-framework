...
var OffsetPopup = function (_React$Component) {
  _inherits(OffsetPopup, _React$Component);

  function OffsetPopup(props) {
    _classCallCheck(this, OffsetPopup);

    var _this = _possibleConstructorReturn(this, (OffsetPopup.__proto__ || Object.getPrototypeOf(OffsetPopup)).call(this, props));
