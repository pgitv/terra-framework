...
var AlignmentPopup = function (_React$Component) {
  ...
  function AlignmentPopup(props) {
    ...
    _this.state = { open: false, attachment: 'top right' };
    return _this;
  }
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'p',
          null,
          'Choose Target Attachment:'
        ),
        _react2.default.createElement(
          'button',
          { type: 'button', id: 'attach-Top', value: 'top right', onClick: this.handleAttachment },
          'Attach Top Right'
        ),
        _react2.default.createElement(
          'button',
          { type: 'button', id: 'attach-Middle', value: 'middle right', onClick: this.handleAttachment },
          'Attach Middle Right'
        ),
        _react2.default.createElement(
          'button',
          { type: 'button', id: 'attach-Bottom', value: 'bottom right', onClick: this.handleAttachment },
          'Attach Bottom Right'
        )
      );
    }
