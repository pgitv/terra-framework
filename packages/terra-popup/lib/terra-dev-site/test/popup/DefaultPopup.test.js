...
var DefaultPopup = function (_React$Component) {
  _inherits(DefaultPopup, _React$Component);

  function DefaultPopup(props) {
    _classCallCheck(this, DefaultPopup);

    var _this = _possibleConstructorReturn(this, (DefaultPopup.__proto__ || Object.getPrototypeOf(DefaultPopup)).call(this, props));
  ...
  _createClass(DefaultPopup, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'button',
          { type: 'button', id: 'default-button', style: { position: 'absolute', left: '125px' }, onClick: this.handleButtonClick, ref: this.setButtonNode },
          'Default Popup'
        )
      );
    }
