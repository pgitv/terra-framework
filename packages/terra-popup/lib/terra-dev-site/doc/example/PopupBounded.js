...
var PopupBounded = function (_React$Component) {
  _inherits(PopupBounded, _React$Component);

  function PopupBounded(props) {
    _classCallCheck(this, PopupBounded);

    var _this = _possibleConstructorReturn(this, (PopupBounded.__proto__ || Object.getPrototypeOf(PopupBounded)).call(this, props));
        ...
        _react2.default.createElement(
          _Popup2.default,
          {
            ...
            targetRef: function targetRef() {
              return document.getElementById('popup-bounded');
            }
          },
          _react2.default.createElement(_ExamplePopupContent2.default, { onChange: this.handleOnChange })
        ),
        _react2.default.createElement(_terraButton2.default, { id: 'popup-bounded', text: 'Bounded Popup', onClick: this.handleButtonClick })
      );
    }
  }]);
