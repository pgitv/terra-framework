...
var _PopupOverlayModule = require('./PopupOverlay.module.scss');

var _PopupOverlayModule2 = _interopRequireDefault(_PopupOverlayModule);
...
var cx = _bind2.default.bind(_PopupOverlayModule2.default);
  ...
  _createClass(PopupOverlay, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        _extends({}, customProps, { className: cx(['popup-overlay', customProps.className]) }),
        _react2.default.createElement('div', { className: cx('inner') }),
        children
      );
    }
  }]);
