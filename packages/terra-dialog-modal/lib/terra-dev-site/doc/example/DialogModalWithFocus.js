...
var DialogModalWithFocus = function (_React$Component) {
  _inherits(DialogModalWithFocus, _React$Component);

  function DialogModalWithFocus(props) {
    _classCallCheck(this, DialogModalWithFocus);

    var _this = _possibleConstructorReturn(this, (DialogModalWithFocus.__proto__ || Object.getPrototypeOf(DialogModalWithFocus)).call(this, props));
  ...
  _createClass(DialogModalWithFocus, [{
    key: 'handleOpenModal',
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement('br', null),
        _react2.default.createElement(_terraButton2.default, { text: 'Close Modal Manager', onClick: this.props.app.closeDisclosure })
      );
    }
  }]);

  return DialogModalWithFocus;
}(_react2.default.Component);

DialogModalWithFocus.propTypes = propTypes;
exports.default = DialogModalWithFocus;