...
var DialogModalWithCustomHeaderAndCustomFooter = function (_React$Component) {
  _inherits(DialogModalWithCustomHeaderAndCustomFooter, _React$Component);

  function DialogModalWithCustomHeaderAndCustomFooter() {
    _classCallCheck(this, DialogModalWithCustomHeaderAndCustomFooter);

    var _this = _possibleConstructorReturn(this, (DialogModalWithCustomHeaderAndCustomFooter.__proto__ || Object.getPrototypeOf(DialogModalWithCustomHeaderAndCustomFooter)).call(this));
  ...
  _createClass(DialogModalWithCustomHeaderAndCustomFooter, [{
    key: 'handleOpenModal',
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          _DialogModal2.default,
          {
            ...
            header: _react2.default.createElement(
              'div',
              { style: CustomHeaderFooterStyles },
              'Custom Header',
              _react2.default.createElement(_terraButton2.default, { id: 'close-dialog-modal', text: 'Close', style: { marginLeft: '10px', float: 'right' }, onClick: this.handleCloseModal })
            ),
        ...
        _react2.default.createElement(_terraButton2.default, { id: 'trigger-dialog-modal', text: 'Trigger Dialog Modal', onClick: this.handleOpenModal })
      );
    }
  }]);
...
exports.default = DialogModalWithCustomHeaderAndCustomFooter;