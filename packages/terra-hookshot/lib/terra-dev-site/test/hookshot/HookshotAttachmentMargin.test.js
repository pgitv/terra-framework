...
var HookshotAttachmentMargin = function (_React$Component) {
  _inherits(HookshotAttachmentMargin, _React$Component);

  function HookshotAttachmentMargin(props) {
    _classCallCheck(this, HookshotAttachmentMargin);

    var _this = _possibleConstructorReturn(this, (HookshotAttachmentMargin.__proto__ || Object.getPrototypeOf(HookshotAttachmentMargin)).call(this, props));

    _this.handleTargetAttachment = _this.handleTargetAttachment.bind(_this);
    _this.state = { attachment: 'middle start' };
    return _this;
  }

  _createClass(HookshotAttachmentMargin, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'p',
          null,
          ' Shoulp apply attachment margin appropriately for all attachment points '
        ),
        _react2.default.createElement(
          'p',
          null,
          ' Choose the content attachement: '
        ),
        _react2.default.createElement(
          'button',
...
exports.default = HookshotAttachmentMargin;