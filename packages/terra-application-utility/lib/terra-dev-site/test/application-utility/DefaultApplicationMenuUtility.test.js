...
var DefaultApplicationMenuUtility = function (_React$Component) {
  _inherits(DefaultApplicationMenuUtility, _React$Component);

  function DefaultApplicationMenuUtility(props) {
    _classCallCheck(this, DefaultApplicationMenuUtility);

    var _this = _possibleConstructorReturn(this, (DefaultApplicationMenuUtility.__proto__ || Object.getPrototypeOf(DefaultApplicationMenuUtility)).call(this, props));
  ...
  _createClass(DefaultApplicationMenuUtility, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        { style: { height: '60px', width: '300px', position: 'relative' } },
...
exports.default = DefaultApplicationMenuUtility;