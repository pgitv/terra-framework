...
var NotificationDialogWithFocus = function (_React$Component) {
  _inherits(NotificationDialogWithFocus, _React$Component);

  function NotificationDialogWithFocus(props) {
    _classCallCheck(this, NotificationDialogWithFocus);

    var _this = _possibleConstructorReturn(this, (NotificationDialogWithFocus.__proto__ || Object.getPrototypeOf(NotificationDialogWithFocus)).call(this, props));
  ...
  _createClass(NotificationDialogWithFocus, [{
    key: 'handleOpenModal',
...
exports.default = NotificationDialogWithFocus;