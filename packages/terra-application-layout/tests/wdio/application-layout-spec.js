...
describe('ApplicationLayout', () => {
  describe('Displays a default application layout', () => {
    beforeEach(() => {
      ...
      browser.waitForVisible('[id=application-layout-test]');
    });

    Terra.should.matchScreenshot({ selector: '[id=application-layout-test]', viewports });
    Terra.should.beAccessible({ viewports, context: '[id=application-layout-test]' });
  });
  ...
  describe('Navigates with top navigation tabs', () => {
    ...
    Terra.should.beAccessible({ context: '[id=application-layout-test]' });
  });
